...
def download_video(url, output_dir=None, resolution=None):
    ...
    if not video_formats:
        ...
        # Use the exact chosen video format and let yt-dlp attach the best
        # available audio track. This avoids falling back to premium-only formats.
        format_spec = f'{chosen[2]}+bestaudio/best'
    ...
    # Prefer the newest file so repeated downloads in the same directory
    # return the artifact produced by the current run.
